...
const projectionEdges: GraphEdge[] = [
  edge('p_rahul', 'p_amit', 'ASSOCIATED_WITH', {
    weight: 0.95, event_count: 63, suspicious: true,
    first_seen: '2026-01-06', last_seen: '2026-03-15',
    evidence_ids: ['CDR-2031', 'CDR-2050', 'SURV-0912', 'TXN-8872'],
  }),
  edge('p_rahul', 'p_iqbal', 'ASSOCIATED_WITH', { weight: 0.8, event_count: 21, suspicious: true, evidence_ids: ['INTEL-77'] }),
  edge('p_rahul', 'p_sunil', 'ASSOCIATED_WITH', { weight: 0.5, event_count: 9 }),
  edge('p_rahul', 'p_manoj', 'ASSOCIATED_WITH', { weight: 0.45, event_count: 7, suspicious: true, evidence_ids: ['INTEL-77', 'CDR-2077'] }),
  edge('p_rahul', 'p_sanjay', 'ASSOCIATED_WITH', { weight: 0.28, event_count: 3, first_seen: '2026-02-24' }),
  edge('p_amit', 'p_iqbal', 'ASSOCIATED_WITH', { weight: 0.7, event_count: 16 }),
  edge('p_amit', 'p_sunil', 'ASSOCIATED_WITH', { weight: 0.78, event_count: 27, suspicious: true, evidence_ids: ['TXN-8890'] }),
  edge('p_amit', 'p_manoj', 'ASSOCIATED_WITH', { weight: 0.6, event_count: 12 }),
  edge('p_iqbal', 'p_preeti', 'ASSOCIATED_WITH', { weight: 0.66, event_count: 11, first_seen: '2026-02-18', suspicious: true, evidence_ids: ['CDR-2044'] }),
  edge('p_iqbal', 'p_sunil', 'ASSOCIATED_WITH', { weight: 0.55, event_count: 8 }),
  edge('p_preeti', 'p_kavya', 'ASSOCIATED_WITH', { weight: 0.72, event_count: 14 }),
  edge('p_preeti', 'p_deepak', 'ASSOCIATED_WITH', { weight: 0.5, event_count: 5, first_seen: '2026-02-26' }),
  edge('p_preeti', 'p_farhan', 'ASSOCIATED_WITH', { weight: 0.5, event_count: 5, first_seen: '2026-02-28' }),
  edge('p_sunil', 'p_deepak', 'ASSOCIATED_WITH', { weight: 0.82, event_count: 18 }),
  edge('p_sunil', 'p_farhan', 'ASSOCIATED_WITH', { weight: 0.76, event_count: 15 }),
  edge('p_sunil', 'p_ravi', 'ASSOCIATED_WITH', { weight: 0.7, event_count: 12 }),
  edge('p_sunil', 'p_imran', 'ASSOCIATED_WITH', { weight: 0.45, event_count: 6 }),
  edge('p_manoj', 'p_ravi', 'ASSOCIATED_WITH', { weight: 0.5, event_count: 7 }),
  edge('p_manoj', 'p_imran', 'ASSOCIATED_WITH', { weight: 0.4, event_count: 4 }),
  edge('p_deepak', 'p_farhan', 'ASSOCIATED_WITH', { weight: 0.4, event_count: 4 }),
  // legit cluster
  edge('p_sanjay', 'p_neha', 'ASSOCIATED_WITH', { weight: 0.9, event_count: 40 }),
  edge('p_sanjay', 'p_vikram', 'ASSOCIATED_WITH', { weight: 0.85, event_count: 33 }),
  edge('p_sanjay', 'p_arjun', 'ASSOCIATED_WITH', { weight: 0.7, event_count: 20 }),
  edge('p_vikram', 'p_arjun', 'ASSOCIATED_WITH', { weight: 0.6, event_count: 16 }),
  edge('p_neha', 'p_vikram', 'ASSOCIATED_WITH', { weight: 0.5, event_count: 10 }),
  edge('p_neha', 'p_pooja', 'ASSOCIATED_WITH', { weight: 0.25, event_count: 2 }),
]
...
const structuralEdges: GraphEdge[] = [
  ...
  edge('p_rahul', 'p_amit', 'CALLED', { event_count: 42, total_duration_min: 318, suspicious: true, first_seen: '2026-01-08', last_seen: '2026-03-14', evidence_ids: ['CDR-2031', 'CDR-2050'] }),
  edge('p_rahul', 'p_iqbal', 'CALLED', { event_count: 18, total_duration_min: 96, evidence_ids: ['INTEL-77'] }),
  edge('p_amit', 'p_sunil', 'CALLED', { event_count: 27, total_duration_min: 142 }),
  edge('p_sunil', 'p_deepak', 'CALLED', { event_count: 15, total_duration_min: 61 }),
  edge('p_sunil', 'p_farhan', 'CALLED', { event_count: 12, total_duration_min: 44 }),
  edge('p_manoj', 'p_ravi', 'CALLED', { event_count: 9, total_duration_min: 25 }),
  edge('p_iqbal', 'p_preeti', 'CALLED', { event_count: 11, total_duration_min: 52, first_seen: '2026-02-18', suspicious: true, evidence_ids: ['CDR-2044'] }),
  edge('p_preeti', 'p_kavya', 'CALLED', { event_count: 14, total_duration_min: 70 }),
  // transfers (person ↔ person, aggregated from TXN)
  edge('p_rahul', 'p_amit', 'TRANSFERRED_TO', { event_count: 6, total_amount: 1800000, suspicious: true, first_seen: '2026-01-19', last_seen: '2026-02-20', evidence_ids: ['TXN-8872', 'TXN-8901'] }),
  edge('p_amit', 'p_sunil', 'TRANSFERRED_TO', { event_count: 5, total_amount: 1250000, suspicious: true, first_seen: '2026-02-02', last_seen: '2026-03-06', evidence_ids: ['TXN-8890'] }),
  edge('p_amit', 'org_mptraders', 'TRANSFERRED_TO', { event_count: 3, total_amount: 600000, suspicious: true, evidence_ids: ['TXN-8901'] }),
  edge('org_mptraders', 'p_rahul', 'TRANSFERRED_TO', { event_count: 2, total_amount: 450000, suspicious: true, first_seen: '2026-02-20', evidence_ids: ['TXN-8901'] }),
  edge('p_sunil', 'p_deepak', 'TRANSFERRED_TO', { event_count: 4, total_amount: 320000, first_seen: '2026-02-10' }),
  edge('p_sunil', 'p_farhan', 'TRANSFERRED_TO', { event_count: 3, total_amount: 280000, first_seen: '2026-02-14' }),
  // located-at
